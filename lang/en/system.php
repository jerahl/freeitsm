...
return [
    ...
    'landing' => [
        ...
        'zabbix_title'      => 'Zabbix',
        'zabbix_desc'       => 'Connect a Zabbix monitoring server (API token) so Service Status can show live problems and host availability.',
        'zabbix_keywords'   => 'zabbix monitoring integration api token problems triggers hosts severity nms network monitoring service status dashboard',
